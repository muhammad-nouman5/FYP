...
?>
        ...
        $laptop=$_GET["laptop"];
        $price = '';
        $query = "select * from laptop WHERE brand='$laptop'";
        if (isset($_GET['startprice'])) {
            $price = "&startprice=" . $_GET['startprice'] . "&endprice=" . $_GET['endprice'];
            $startprice = $_GET['startprice'] / 156;
            $endprice = $_GET['endprice'] / 156;
            $query = "select * from laptop WHERE brand='$laptop' AND price BETWEEN '$startprice' AND '$endprice'";
        }
            ...
            <div class="col-lg-3 col-md-6 mb-2">
                <div class="card">
                    <a href="#"><img class="card-img-top" style="height:200px; width:312px;"
                            src="laptop_pics/<?php echo $row['laptop_name'] ?>.jpg"></a>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                            <h6 class="text-right">
                                ...
                                <a class="btn rounded-0 btn-sky ml-2" href="php/Addtocartlaptop.php?id=<?php echo $row['id']; ?>&laptop=<?php echo $laptop . $price; ?>">Add to Cart</a>
                            </h6>
                        </div>
            </div>
            </div><?php
