...
<body>
    <div id="#home">
        ...
        <div class="row mt-3" style="margin-left:5px;">
            ...
            <?php
            $mobile = $_GET["mobile"];
            $query = "select * from mobiles WHERE brand='$mobile'";
            $price = '';
            if (isset($_GET['startprice'])) {
                ...
                $query = "select * from mobiles WHERE brand='$mobile' AND price BETWEEN '$startprice' AND '$endprice'";
            }
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <h6 class="text-right">
                                ...
                                <a class="btn rounded-0 btn-sky ml-2" href="php/Addtocart.php?id=<?php echo $row['id']; ?>&mobile=<?php echo $mobile . $price; ?>">Add to Cart</a>
                            </h6>
